    ...
    <div class="row">
       ...
       <?php echo form_open(base_url('Home/forgotPassword'), array('id' => 'front_forgotPassword')); ?>
        ...
        <div class="loginBox">
          ...
          <p class="box-title suc_msg_hide"><?php echo $this->session->flashdata('suc_msg_forgot');?></p>
          <p class="Sign_text">Enter your email address and we will get link to your email address for reset password.</p>
          ...
          <input type="submit" name="submit" value="Send" class="loginbtn" \>
