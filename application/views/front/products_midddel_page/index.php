<div class="col-12 col-lg-8 col-xl-8 col-md-12 myGroup">
                    ...
                    <div class="col-12 col-lg-7 col-xl-7 col-md-12 ">
                        ...
                        <div class="text-right">
                            ...
                            <?php if($this->uri->segment(1) == 'dashboard') {?>                                  
                                <a href="<?php echo base_url() . 'bookRoom/' . $row->id; ?>"><button type="button" class="More_infoBtn"> Book Again</button></a>
                            <?php }else{ ?>
    ...
    <?php } else { ?>
        <div class="room_content">
            <div class="row">
                <img src="<?php echo base_url() . FRONT_CSS_JS; ?>images/ROOMS.png">
            </div>
        </div>
    <?php } ?>
    ...
    <?php if ($other_rooms) { ?>
        <?php foreach ($other_rooms as $row) { ?>
            <div class="room_content">
                <div class="row">
                    <div class="col-12 col-lg-5 col-xl-5 col-md-12">
                        <?php if ($row->images) { ?>
