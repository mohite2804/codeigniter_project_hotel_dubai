                    ...
                    <div class="row">
                            ...
                            <div class="relativepos pro_ad">
                                ...
                                <div class="childrenCount row  " id="Roomnumber">
                                    <div class="children_box">
                                        ...
                                        <input name="no_of_room" value="<?php if(!empty($selected_data['no_of_room'])) echo $selected_data['no_of_room']; else echo '1';?>" type="text" class="adultInput" >
                        ...
                        <div class="col-12 col-lg-6 col-xl-6 col-md-6">
                            <div class=" checKDate">
                                ...
                                <input name="room_start_date" autocomplete="off" id="startDate" value="<?php if(!empty($selected_data['room_start_date'])) echo $selected_data['room_start_date']; else echo set_value('room_start_date');?>" class="form-control" placeholder="Check In" />
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-lg-6 col-xl-6 col-md-6">
                            <div class="checKDate">
                                ...
                                <input name="room_end_date" value="<?php if(!empty($selected_data['room_end_date'])) echo $selected_data['room_end_date']; else echo set_value('room_end_date');?>" autocomplete="off" id="endDate" class="form-control" placeholder="Check Out" />
                            </div>
                        </div>
                            ...
                            <div class="relativepos pro_ad">
                                ...
                                <div class="childrenCount row  " id="adultnumber">
                                    <div class="children_box">
                                        ...
                                        <input name="room_no_of_adult" type="text" class="adultInput" value="<?php if(!empty($selected_data['room_no_of_adult'])) echo $selected_data['room_no_of_adult']; else echo '1';?>">
                            ...
                            <div class="relativepos pro_ad">
                                ...
                                <div class="childrenCount row  " id="childrennumber">
                                    <div class="children_box">
                                        ...
                                        <input name="room_no_of_children" type="text" class="adultInput" value="<?php if(!empty($selected_data['room_no_of_children'])) echo $selected_data['room_no_of_children']; else echo '1';?>">
                        ...
                        <div class="col-12 col-lg-12 col-xl-12 col-md-12">
                            <div class="relativepos pro_ad">
                            <br>      
                            <input type="submit" name="submit" value="Update" class="book_hotel" \>
