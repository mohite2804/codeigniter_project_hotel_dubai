                ...
                <table class="maintb" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td style="padding: 0px 20px;background-color: #373737;">
                            ...
                            <p style="font-size: 20px;text-align: center;color: #fff;font-weight: normal; line-height: 24px; margin-bottom:29px;">
                    ...
                    <tr>
                        <td style="padding: 0px 20px;background-color: #fff;">
                            <p style="font-size: 19px;text-align: center;color: #3B4856;font-weight: normal;margin-bottom: 18px;margin-top: 20px;line-height: 29px;">Hi<br> A Request had been received to change the password for your Sitara Apartment Hotel Account.</p>
                        </td>
                    </tr>
                            ...
                            <table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="background-color: #EE353B;height: 32px;text-align: center;color: #fff;font-weight: bold;">
                                        <a href="<?php echo $forgot_password_link; ?>" target="_blank" style="color: #fff;text-decoration: none;">Reset Password</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
