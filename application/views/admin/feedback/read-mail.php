				...
				<form id="frm_punch_card_add_update" class="form-horizontal" method="post"  enctype="multipart/form-data"  action="" >
                  ...
                  <div class="box-body">
					...
					<div class="form-group">
						<label for="inputEmail3" class="col-sm-2 control-label">Users Name</label>
						<div class="col-sm-10">
							<label  class="control-label"><?php echo $result[0]->user_fullname;?></label>
						</div>
					</div>
						...
						<?php if(!empty($result)) { ?>
							<?php foreach($result as $row) { ?>
								<span id="image_delete_<?php echo $row->id;?>" >
									<image  src="<?php echo base_url().'uploads/user_album/100x100/'.$row->image;?>" />
                  ...
                  <div class="box-footer">
					<input name="user_id" value="<?php echo $result[0]->user_id;?>"  type="text" >
					<input name="category_id" value="<?php echo $result[0]->category_id;?>"  type="text" >
					
					<input name="created_at" value="<?php echo date('Y-m-d H:i:s');?>"  type="text" >
