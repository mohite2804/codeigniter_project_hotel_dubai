        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li style="margin-right: 10px;margin-top: -8px;" > 
			  <a href="<?php echo base_url().'Admin/addAdminAlbum';?>">	<button class="btn btn-primary btn-sml" >Add</button>  </a>
			</li>
						...
						<?php $i=1; foreach($result as $row){ ?>
							<tr>
								...
								<td>
									...
									<a title="Edit Photo" href="<?php echo base_url().'Admin/editAdminAlbum/'. $row->category_id;?>" ><i class="glyphicon glyphicon-pencil"></i></a>									
								</td>
							</tr>
						<?php $i++;} ?>
					<?php } ?>
