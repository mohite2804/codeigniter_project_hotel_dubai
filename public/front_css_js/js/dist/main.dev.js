...
if (windowWidth > 992) {
  ...
  $('.bxslider').bxSlider({
    onSlideAfter: function onSlideAfter(currentSlideNumber, totalSlideQty, currentSlideHtmlObject) {
      console.log(currentSlideHtmlObject);
...
$('#toggler_menu').click(function () {
  ...
  $('.close_ic').show(); // $('#toggler_menu').hide();
});
...
$('.services_list ul li div').click(function () {
  $(this).toggleClass('active_alpha'); //$(this).siblings().child().removeClass('active_alpha');
});
